	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="collapsePages" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="admin/login">Login</a> <a
							class="collapse-item" href="admin/register">Register</a> <a
							class="collapse-item" href="admin/forgot-password">Forgot
							Password</a>
			...
			<li class="nav-item"><a class="nav-link" href="admin/category">
					<i class="fas fa-fw fa-tasks"></i> <span class="font-weight-bold">CATEGORY</span>
			</a></li>
			<li class="nav-item"><a class="nav-link" href="admin/product">
					<i class="fas fa-fw fa-mobile"></i> <span class="font-weight-bold">PRODUCT</span>
			</a></li>
			<li class="nav-item"><a class="nav-link" href="admin/order">
					<i class="fas fa-fw fa-mobile"></i> <span class="font-weight-bold">Order</span>
			</a></li>
			<!-- Divider -->
				...
				<div class="container-fluid">
					...
					<div
						...
						<a href="/home"
							...
							class="fas fa-download fa-sm text-white-50"></i> Goto Website</a>
					</div>
